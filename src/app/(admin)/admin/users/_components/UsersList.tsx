...
import { Shield, ArrowRight, MoreVertical, Trash2, RotateCcw } from "lucide-react";
...
export default function UsersList({ users }: UsersListProps) {
  ...
  const { deleteUser, restore } = useUser();
  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      ...
      <ConfirmModal
        ...
        description={
          deleteConfirm
            ? `Bạn có chắc chắn muốn xóa người dùng "${deleteConfirm.fullName}"? Hành động này không thể hoàn tác.`
            : ""
        }
        confirmLabel="Xóa"
        variant="danger"
