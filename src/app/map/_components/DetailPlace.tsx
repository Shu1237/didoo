...
const DetailPlace = ({ eventData }: DetailPlaceProps) => {
  return (
    <Link href={`/events/${eventData.id}`}>
      <div className="bg-gradient-to-br from-primary/10 via-accent/5 to-background border border-primary/20 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:border-primary/40 transition-all duration-300 cursor-pointer group">
        {/* Image */}
