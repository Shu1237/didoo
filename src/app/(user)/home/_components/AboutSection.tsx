                ...
                <div className="flex flex-col lg:flex-row items-center gap-0 lg:gap-12">
                    ...
                    >
                        <h2 className="text-4xl md:text-6xl font-black text-black leading-[0.9] tracking-tighter mb-8 uppercase">
                            Kết nối với <br />
                            <span className="text-gray-400">Cộng đồng.</span>
                        </h2>

                        <p className="text-lg text-gray-600 font-medium leading-relaxed mb-12 max-w-lg">
                            DiDoo xây dựng hệ sinh thái nơi thiết kế và kinh doanh gặp gỡ.
                            Từ workshop đến masterclass, chúng tôi kết nối những bộ óc xuất sắc nhất.
                        </p>

                        <div className="space-y-6">
                            <h4 className="text-sm font-bold text-black uppercase tracking-widest">Các chủ đề bao gồm</h4>
