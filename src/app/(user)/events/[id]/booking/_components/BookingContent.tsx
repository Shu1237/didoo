...
import { BookingDraftItem } from "../page";
...
export const BookingContent = observer(
  ({
    eventId,
    event,
    ticketTypes,
    ...
    const TicketCard = ({
      ...
      const avail = ticketStore$.availability[eventId][tt.id].get() ?? Math.max(0, Number(tt.availableQuantity ?? 0));
